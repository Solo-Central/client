...
function menuWatchA() {
	window.open('https://solocentral.org');
}
...
function drawMenu() {
	...
	else drawMenu0Button('SOLO CENTRAL', 665.55, 303.75, false, menuWatchA);
	if (showingNewGame2) {
...
function exploreCopyLink() {
	copyText('https://play.qatual.com/games/ports/bfdi5b/?' + (exploreLevelPageType===0?'level=':'levelpack=') + exploreLevelPageLevel.id);
}
